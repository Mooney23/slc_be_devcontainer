...
description: >-
  ...
  any backend (Python / DB) service repo; lives alongside the behavioural knowledge base under the same
  `docs/` root and cross-references it. Suggest recording an ADR proactively when a real trade-off is
